...
import com.example.user.weatherku.weather.WeatherFragmentHari;
import com.example.user.weatherku.weather.WeatherManager2;
...
public class Harian extends AppCompatActivity {
    private static final String TAG = Harian.class.toString();
    private static final String TAG_FRAGMENT = "tag_fragment";

    private WeatherFragmentHari nWeatherFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nWeatherManager = new WeatherManager2(this);
        initView2();
    }
...
//                return true;
    ...
    private void initView2() {
        ...
        replaceFragment(getWeatherFragmentt(), false);
    ...
    public WeatherFragmentHari getWeatherFragmentt() {
        if (nWeatherFragment == null) {
            nWeatherFragment = new WeatherFragmentHari();
        }
