 ...
 */
public class WeatherManager2 {
    private static final String TAG = WeatherManager2.class.toString();
    ...
    public WeatherManager2(Harian mainActivity) {
    ...
    public void fetchSearchWeatherData(Observable<String> city) {
        ...
        .subscribe(new Subscriber<List<WeatherBase>>() {
            ...
            public void onNext(List<WeatherBase> weatherBases) {
                ...
                nMainView.getWeatherFragmentt().setRefreshing(false);
    ...
    public void displayCurrent(CityWeather cityWeather) {
        ...
        nMainView.getWeatherFragmentt().setCityWeather(cityWeather);
    }

    public void displayForecast(Forecast forecast) {
        Log.d(TAG, "displayForecast");
        nMainView.getWeatherFragmentt().setForecast(forecast);
    }

    public void displayCurrentByCity(CurrentByCity currentByCity) {
        nMainView.getWeatherFragmentt().setCurrentByCity(currentByCity);
    }
