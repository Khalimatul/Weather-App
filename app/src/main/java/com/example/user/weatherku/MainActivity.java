...
import com.example.user.weatherku.weather.WeatherFragmentNow;
import com.example.user.weatherku.weather.WeatherManager;
...
public class MainActivity extends AppCompatActivity {
    ...
    private WeatherFragmentNow mWeatherFragment;
...
//                return true;
    ...
    private void buildAlertMessageNoGps() {
        ...
        builder.setMessage("Aktifkan Layanan Lokasi agar dapat menentukan lokasi anda saat ini")
                .setCancelable(false)
    ...
    public WeatherFragmentNow getWeatherFragment() {
        if (mWeatherFragment == null) {
            mWeatherFragment = new WeatherFragmentNow();
        }
    ...
    public void showCityList(CityWeather[] cityWeathers) {
        ...
        String info = "Pilih kota tempat tinggal anda";
