...
import com.example.user.weatherku.weather.WeatherFragmentJam;
import com.example.user.weatherku.weather.WeatherManager3;
...
public class PerJam extends AppCompatActivity {
    private static final String TAG = PerJam.class.toString();
    private static final String TAG_FRAGMENT = "tag_fragment";

    private WeatherFragmentJam nWeatherFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_per_jam);
        ...
        nWeatherManager = new WeatherManager3(this);
        initView2();
    }
    ...
    protected void onResume() {
        ...
        nWeatherManager.checkLocationState();
...
//        Button button = menu.findItem(R.id.action_settings);
...
//                return true;
    ...
    private void searchWeather(String city) {
        nWeatherManager.fetchSearchWeatherData(Observable.just(city));
    }
    ...
    private void initView2() {
        ...
        replaceFragment(getWeatherFragmenttt(), false);
    ...
    public WeatherFragmentJam getWeatherFragmenttt() {
        if (nWeatherFragment == null) {
            nWeatherFragment = new WeatherFragmentJam();
        }
        return nWeatherFragment;
    }
        ...
        public CityViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    nWeatherManager.storeCityName(mCityList.get(getAdapterPosition()).name);
                }
            });
        }
    }
